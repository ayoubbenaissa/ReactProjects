...
const AddEducation = ({ addEducation, history }) => {
    ...
    return (
        ...
        <form className="form" onSubmit={e => {
            ...
            <input type="text" placeholder="* degree" name="degree" value={degree} onChange={e => onFieldChange(e)} required />
            </div>
            <div className="form-group">
            <input type="text" placeholder="* school" name="school" value={school} onChange={e => onFieldChange(e)} required />
            </div>
            <div className="form-group">
            <input type="text" placeholder="field of study" name="fieldofstudy" value={fieldofstudy} onChange={e => onFieldChange(e)} />
            </div>
            <div className="form-group">
            <h4>From Date</h4>
